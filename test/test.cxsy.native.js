...
var cxsy = tryRequire( resolve( __dirname, './../lib/cxsy.native.js' ) );
var opts = {
	'skip': ( cxsy instanceof Error )
};
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( cxsy.length, 5, 'has expected arity' );
	t.end();
});
